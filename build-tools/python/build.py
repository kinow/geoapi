...
os.makedirs(dir)
files = glob.glob('../../standard/python/opengis/metadata/*.py')
for f in files:
    shutil.copy2(f, dir)
...
os.makedirs(dir)
files = glob.glob('../../bridges/python/opengis/bridge/java/*.py')
for f in files:
    shutil.copy2(f, dir)
...
dir = 'opengis/wrapper/'
os.makedirs(dir)
files = glob.glob('../../examples/python/opengis/wrapper/*.py')
for f in files:
    shutil.copy2(f, dir)
